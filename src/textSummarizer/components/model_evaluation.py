...
class ModelEvaluation:
    ...
    def generate_batch_sized_chunks(self, list_of_elements, batch_size):
        ...
        Args:
            list_of_elements (_type_): _description_
    ...
    def calculate_metric_on_test_ds(
        ...
        article_batches = list(
            self.generate_batch_sized_chunks(
                list_of_elements=dataset[column_text], batch_size=batch_size
            )
        )

        target_batches = list(
            self.generate_batch_sized_chunks(
                list_of_elements=dataset[column_summary], batch_size=batch_size
            )
        )
